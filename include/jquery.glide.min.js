(function(e,t,n,r){function o(r,i){
    var o=this;
    ...
    if(o.options.touchDistance){
        o.swipe()}if(o.options.keyboard){e(n).on("keyup",function(e){
    ...
    return{
        current:function(){
            ...
            ,play:function(){o.play()}
            ,pause:function(){o.pause()}
            ,next:function(e){o.slide(1,false,e)}
            ,prev:function(e){o.slide(-1,false,e)}
            ,jump:function(e,t){o.slide(e-1,true,t)}
            ,nav:function(e){
                if(o.navWrapper){
                    o.navWrapper.remove()
                }
                o.options.nav=e?e:o.options.nav;o.navigation()
            }
            ,arrows:function(e){
                if(o.arrowsWrapper){
                    o.arrowsWrapper.remove()
                }
                o.options.arrows=e?e:o.options.arrows;o.arrows()
            }
        }
    }
    function u(e){
        ...
        if(i===false){
            ...
            for(var a=0;a<s.length;a++){
                if(o.style[s[a]+u]!==r){i=true;break
                }
            }
        }
        if(t.opera){
